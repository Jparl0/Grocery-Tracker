...
class ListItemsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create list_item" do
    assert_difference("ListItem.count") do
      post list_items_url, params: { list_item: { list_id: @list_item.list_id, name: @list_item.name } }, as: :json
    end
  ...
  test "should update list_item" do
    patch list_item_url(@list_item), params: { list_item: { list_id: @list_item.list_id, name: @list_item.name } }, as: :json
    assert_response :success
  end
